...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/21 16:06:46 by gabrrodr          #+#    #+#             */
/*   Updated: 2024/02/21 16:06:46 by gabrrodr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(const std::string& name) : _name(name), _hitPts(100), _energyPts(50), _attackDamage(20) {
